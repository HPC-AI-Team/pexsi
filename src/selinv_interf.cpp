...
//    Functions 
//------------------
void SELINV_Interface::ldlt_preprocess__(int *token, int *n,    int *colptr,
...
/*DEBUG end*/
    ...
    if (*token > 5 || *token < 0) { //maxm mohan modify 2011-09-27
...
void SELINV_Interface::ldlt_fact__(int *token, int *colptr, int *rowind, doublecomplex *nzvals)
{
...
void SELINV_Interface::ldlt_solve__(int *token, doublecomplex *x, doublecomplex *rhs)
{
    int     neqns, nsuper, i;
    int     *perm, *invp;
    doublecomplex  *newrhs;
...
void SELINV_Interface::ldlt_getdiag__(int *token, doublecomplex *diag)
{
    int i, neqns;
...
void SELINV_Interface::ldlt_extract__(int *token, doublecomplex *diag)
{
...
void SELINV_Interface::ldlt_blkextract__(int *token, doublecomplex *diag, int *dumpL)
{
    int   i, nnzl, neqns, nsuper;
    doublecomplex  *ytemp;
...
void SELINV_Interface::ldlt_blkselinv__(int *token, int* colptr, int* rowind, 
...
void SELINV_Interface::ldlt_free__(int *token)
{
