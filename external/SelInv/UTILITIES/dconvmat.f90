...
!       ****************************************************************
!
!       DCONVMAT.F converts the Matrix Market (MM) format to the 
!       ccf format that cselinv.x uses. This subroutine utilizes mmio.f 
!       provided by Matrix Market.
!
!       usage: dconvmat.x -infile=<input file name> -outfile=<output file name>
!
...
!       to .ccf format, run
!
!       dconvmat.x -infile=H.mtx -outfile=H.ccf
