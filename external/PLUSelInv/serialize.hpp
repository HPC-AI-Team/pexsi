...
inline int combine(double& val, double& ext)
{
  val += ext;
  return 0;
}
...
inline int combine(cpx& val, cpx& ext)
{
  val += ext;
  return 0;
}
...
template<class T>
int combine(vector<T>& val, vector<T>& ext)
{
  iA(0);
  return 0;
}
...
template<class T>
int combine(set<T>& val, set<T>& ext)
{
  iA(0);
  return 0;
}
...
template<class T, class S>
int combine(map<T,S>& val, map<T,S>& ext)
{
  iA(0);
  return 0;
}
...
template<class T, class S>
int combine(pair<T,S>& val, pair<T,S>& ext)
{
  iA(0);
  return 0;
}
